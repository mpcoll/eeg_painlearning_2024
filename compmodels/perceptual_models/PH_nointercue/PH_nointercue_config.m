function c = PH_nointercue_config
...
% Initial a
c.logita_0mu = tapas_logit(0.5, 1);
c.logita_0sa = 1;

% Gamma
c.logitgamu = tapas_logit(0.5, 1);
c.logitgasa = 1;
...
c.prc_fun = @PH_nointercue;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @PH_nointercue_transp;

...
p.customfuncpath = ['/media/mp/Crucial X8/2023_painlerarning_validate_R2Rpain/code/compmodels'];
% Where is the data
p.datafile =  ['/media/mp/Crucial X8/2023_painlerarning_validate_R2Rpain/derivatives/task-fearcond_scr_glmresp_processed.mat'];
% Ouput path
m.path = '/media/mp/Crucial X8/2023_painlerarning_validate_R2Rpain/derivatives/computational_models';;
if ~exist(m.path, 'dir')
   mkdir(m.path)
end
